...
export declare const NitrApi: (token?: string | undefined) => {
    path: <URLString extends keyof import("./interface/api/global").Global | keyof import("./interface/api/oauth2").OAuth2 | keyof import("./interface/api/registration").Registration | keyof import("./interface/api/user").User | keyof import("./interface/api/service").Service | "/services/{id}/bouncers" | keyof import("./interface/api/cloud_server").Cloud_Server | keyof import("./interface/api/cloud_server_apps").Cloud_Server_Apps | "/company/stats" | keyof import("./interface/api/domain").Domain | keyof import("./interface/api/game_server").Game_Server, Params extends ParamsRecord<URLString, Record<string, string>>>(url: URLString, params: Params) => URLs[URLString];
};
